...
\noindent Das Resultat der Berechnung der genetischen Varianz $\sigma_G^2$ f\"ur einen Lokus mit zwei Allelen zeigt, dass diese Varianz aus zwei Teilen besteht.
