...
matAddContribToAinv <- function(pnAniIdx, pnSireIdx = NULL, pnDamIdx = NULL, pnAlpha, pmatAInv){
  ...
  if (!is.null(pnSireIdx) & !is.null(pnDamIdx)) {
    matResult <- matAddStringToMatrixComp(pmMat = matResult,
